...
@section('breadcrumb')
   ...
   {{ Breadcrumbs::render('outstanding') }}
      ...
      <div class="col-lg-10">
       <form action="" method="post">
        @csrf 
            ...
            <input type="hidden" name="blog-outstanding-choose" value="{{ json_encode($ids) }}">
       </form>
      </div>
    </div>
  </section>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".is-save").click(function (e) {
                ...
                var input = `<input type="hidden" name="blog-outstanding" value="${JSON.stringify( data )}">`;
                $('form').append(input);
                $('form').submit();
            });
        });
