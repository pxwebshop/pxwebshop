...
<?php /*----------------------------------------*/ ?>
<div class="c-dev-title2">c-header</div>
		...
		<div class="c-header__top pc-only">
			<div class="l-container">
				...
				<ul class="c-header__address">
					...
					<li class="c-header__address__item">
						<a href="tel: 020 28266650"><i class="fa-solid fa-phone"></i> 020 28266650</a>
					</li>
				</ul>
			</div>
		</div>
			...
			<ul class="c-header__gnav__menu">
				...
				<li class="c-header__itemSeach">
					<div class="c-header__search">
						<form action="https://pxwebshop.com/index.php/" class="c-header__form search" role="search" method="get">
                            <input type="search" name="s" placeholder="ໃສ່ຂໍ້ມູນທີ່ຕ້ອງການຄົ້ນຫາ" value="" id="search-form-630f7d25799fb">
